...
function Contact() {
  ...
  return (
    <div
      className="h-[100vh] w-[100vw] flex-row flex items-center justify-center"
      data-aos="fade-up"
    ...
    >
      ...
      <div className="form h-[80vh] w-[50vw]  " data-aos="fade-left"
        ...
        <button
          type="button"
          className="text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-[35vw]"
        >
          Submit
        </button>
      </div>
