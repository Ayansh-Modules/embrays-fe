...
function ClientThought(props) {
  ...
  return (
    <div>
      <div className="max-md:ml-[25vw] max-sm:ml-[15vw] block min-w-[250px] w-[26vw] max-sm:w-[40vw] max-lg:[80vw] h-[17rem] max-md:text-xs overflow-x-clip p-5 border-2  rounded-2xl border-black hover:bg-gray-100 bg-white ">
