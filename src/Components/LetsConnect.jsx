...
function LetsConnect({ onClose }) {
  ...
  useEffect(() => {
    const handleSubmit = (event) => {
      ...
      fetch("/", {
        ...
        body: new URLSearchParams(formData).toString(), // Converts form data to a URL-encoded string
      })
        .then(() => {
    ...
    const formElement = document.getElementById("enquiryFormModal");
  ...
  return (
    ...
    >
      ...
      {popupVisible && (
        <div id="popup" className="popup fixed top-4 border-2 border-Layoutblue py-4 px-10 bg-green-500 text-white rounded-lg">
