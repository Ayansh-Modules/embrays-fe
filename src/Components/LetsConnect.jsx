      ...
      <form name="contact" method="POST" data-aos="zoom-in">
        ...
        >
          ...
          <div className=" p-5 flex items-center justify-center">
            <button
              type="button "
              className=" max-md:w-[80vw] text-white bg-gradient-to-r from-pink-500 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-[30vw]"
            >
              Submit
            </button>
          </div>
