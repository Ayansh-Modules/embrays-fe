const appData = {
  ...
  services: {
    ...
    ourService: [
      { id:1,
        serviceOne: "Digital Marketing",
        testimonial  : "Empowering Business through Innovative and Strategic digital marketing solutions that drive growth , enhance brand visibility and foster meaningful customer engagement."
      },
      

      {  id:2,
        serviceTwo: " App & Website Development",
      ...
      {  id:3,
        serviceThree: "UI/UX Design" ,
        testimonial : "Elevate user experiences with our cutting-edge UI/UX design. We seamlessly blend aesthetics and functionality, \n bringing your brand's digital identity to life."
      },
      {  id:4,
  ...
  how_it_works:{
    ...
    {
      title : "Scoping",
      testimonial : "Streamline the purpose and the scope of your product with our carefully curated questionnaire.",
    },
    {
      title : "Validation",
      testimonial : "Get your idea validated with the help of our network of experts across diverse backgrounds.",
    },
    {
      title : "MVP",
      testimonial : "Build the MVP of your product with our battle proven tech stack that will get you started without incurring huge infra bills.",
    },
    {
      title : "Scale up",
      testimonial : "Scale your product to add great features and handle larger traffic with our agile based development approach.",
    }
  ]
  },
    collaboration: {
      title: "CELEBRATING OUR COLLABORATIONS",
      content: [
        {
          company: "CoachPx",
  ...
  clientReview: {
    ...
    subTitle:
      ...
      allReviews: [
        {
          company: "CoachPx",
          review: "Thanks to Embrays Technologies, our app development journey with IamRapid was a breeze. Their team's technical prowess and collaborative approach ensured that our product surpassed expectations. Grateful for their support in turning our dream into a tangible product!"
        },
        {
          company: "Compliant Labs",
        ...
        {
          company: "StockDaddy",
          review: "Working with Embrays Technologies to develop the StockDaddy app was a fantastic experience. Their team's attention to detail and willingness to go the extra mile ensured that our app not only met but exceeded our expectations. We're incredibly grateful for their expertise and support throughout the development process!"
        },
        {
          company: "Settlrs",
          review: "We're thrilled with the website that Embrays Technologies helped us create for Settlrs. Their expertise and attention to detail ensured that our brand identity was perfectly captured in the final product. Working with their team was a pleasure, and we would highly recommend their services to anyone looking for top-notch web development."
        },
        {
          company: "TuitionBud",
          review: "Embrays Technologies was instrumental in the creation of our TuitionBud platform. Their technical expertise and attention to detail were evident throughout the development process. The final product perfectly encapsulates our vision, and we couldn't be happier with the outcome. Highly recommend their services!"
        },
        {
          company: "IamRapid",
          review: "Thanks to Embrays Technologies, our app development journey with IamRapid was a breeze. Their team's technical prowess and collaborative approach ensured that our product surpassed expectations. Grateful for their support in turning our dream into a tangible product!"
